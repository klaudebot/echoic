...
export const demoMeetings: Meeting[] = [
  ...
  },
  {
    ...
    transcript: [
      ...
      { speaker: "Sophie Bennett", text: "On the content side, I've been analyzing what drives organic traffic. Comparison pages — like 'Echoic vs Otter' — convert three times better than blog posts. And video tutorials on YouTube are our fastest-growing traffic source.", timestamp: 175, confidence: 0.97, sentiment: "positive" },
  ...
  },
  {
    ...
    transcript: [
      { speaker: "Jake Morrison", text: "Welcome back to TechTalk. Today I'm joined by the founder and CEO of Echoic, the AI meeting assistant that's been blowing up in the productivity space. Thanks for being here.", timestamp: 0, confidence: 0.98, sentiment: "positive" },
