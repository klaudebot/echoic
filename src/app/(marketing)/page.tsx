      ...
      <section id="features" className="py-32 sm:py-40">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-px bg-border sm:grid-cols-2 lg:grid-cols-3 border border-border">
            {features.map((f, i) => (
                <div key={i} className="relative bg-card p-8 sm:p-10 hover:bg-muted/30 transition-colors">
                  {f.badge && (
          ...
          <div className="grid gap-0 md:grid-cols-3">
            {[
              ...
              { step: "03", title: "Review & Act", description: "Searchable transcripts, smart clips, action item tracking, and decision logs. Meeting knowledge for everyone.", color: "brand-emerald" },
                ...
                <div key={i} className="relative p-10 md:p-12 border-b md:border-b-0 md:border-r border-border last:border-0">
